...
class AzureJob extends Job {
     ...
     */
    public function __construct(Container $container, IServiceBus $azure, BrokeredMessage $job, $queue, $handler) {
        $this->azure     = $azure;
        $this->job       = $job;
        $this->queue     = $queue;
    ...
    public function fire() {
        $this->resolveAndFire(['job' => $this->handler, 'data' => $this->getRawBody()]);
    }
