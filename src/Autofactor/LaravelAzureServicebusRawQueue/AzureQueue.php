...
class AzureQueue extends Queue implements QueueInterface {
    ...
    /**
     * The class that will handle the jobs
     *
     * @var string
     */
     ...
     */
    public function __construct(IServiceBus $azure, $default, $job_handler) {
        $this->azure   = $azure;
    ...
    public function pop($queue = null) {
        ...
        if (!is_null($job)) {
            return new AzureJob($this->container, $this->azure, $job, $queue, $this->job_handler);
        }
    }
